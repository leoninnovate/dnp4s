...
object Section741210 extends TestProcedure with RequiresAnalogOutputControlSupport {

  import AnalogOutputOptions._

  def id = "7.4.1.2.10"
  def description = "SBO, Select Retry (Same Sequence Number)"
  ...
  /*
7.4.1.2.10 SBO, Select Retry (Same Sequence Number)
