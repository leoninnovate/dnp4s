...
object Section721214 extends TestProcedure with RequiresGroup12Var1Support {
  ...
  def steps(options: TestOptions) = {
    val index = CrobOptions.getInvalidIndex1(options)
...
/*
7.2.1.2.14 SBO, Operate Retry (Same Sequence Number)
